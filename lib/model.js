...
import {noOp, urlError, wrapError} from './utils.js';
...
export default class Model {
  constructor(attributes={}, options={}) {
    ...
    this.set({...result(this, 'defaults'), attributes}, options);
    this.changed = {};
  ...
  unset(attr, options) {
    return this.set(attr, undefined, {...options, unset: true});
  }
  ...
  save(key, val, options) {
    ...
    options = {...options, validate: true, parse: true};
